            ...
            <div class="login-footer">
                <template v-if="loginMode === 'pwd'">
                    ...
                    <div class="oauth-group">
                        ...
                        <div class="oauth-item qq" title="QQ登录" @click="qqLogin">
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"  viewBox="0 0 15.5 15.5">
...
const qqLogin = () => handleOAuthLogin('qq')
